...
# # Правила
# # 1. Если размерности массивов отличаются, 
# # то форма массива с меньшей размерностью дополняется 1 с левой стороны

# # 2. Если формы массивов не совпадают в каком-то измерении,
# # то если у массива форма равна 1, то он "растягивается" до соответствия формы второго массива

# # 3. Если в каком-либо измерении размеры отличаются и ни один из них не равен 1, 
...
# задание 2: > 3 и < 9
print (np.sum(3 < y)-np.sum(y>=9)) # топорно, но работает
print (np.sum((3 < y) & (y < 9) )) # по умному
